...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # bindings the app to the current context
    ...
    def test_get_paginated_questions(self):
        ...
        # geting response and load data accordingly 
        response = self.client().get('/questions')
        data = json.loads(response.data)

        # checking status code & message
    ...
    def test_delete_question(self):
        ...
        # get number of questions after deletation 
        ...
        # check if question id matching the deleted id
    ...
    def test_create_new_question(self):
        ...
        # creating new question and load response data
